...
public class AuthController {
    ...
    public String confirmEmailController(@RequestParam("action") String action, @RequestParam("hash") String hash, @RequestParam(value = "user_id", required = false, defaultValue = "null") String userIdString) {
        if (action.equals("registration")) {
            ...
            userService.createUser(emailRegistration.getReferrer(), domain, emailRegistration.getEmail(), emailRegistration.getUsername(), emailRegistration.getPassword(), null, emailRegistration.getDomainName(), emailRegistration.getPlatform(), emailRegistration.getRegIp(), emailRegistration.getPromocodeName(), emailRegistration.getRefId(), true);
