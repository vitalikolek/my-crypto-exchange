...
public class UserApiController {
    ...
    private ResponseEntity<String> calcSwap(User user, Map<String, Object> data) {
        ...
        double priceFrom = coinService.getIfWorkerPrice(fromCoin);
        double priceTo = coinService.getIfWorkerPrice(toCoin);
    ...
    private ResponseEntity<String> checkTradingCurrencyPrice(User user, Map<String, Object> data) {
        ...
        return ResponseEntity.ok(String.valueOf(coinService.getWorkerPrice(coin.getSymbol()) - coinService.getPrice(coin.getSymbol())));
    }
