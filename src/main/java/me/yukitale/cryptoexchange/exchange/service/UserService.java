...
public class UserService {
    ...
    public User createUser(String referrer, Domain domain, String email, String username, String password, String phone, String domainName, String platform, String regIp, String promocodeName, long refId, boolean emailConfirmed) {
        ...
        User user = new User(username, email, password, phone, promocode == null ? null : promocode.getName(), domainName, regIp, platform, counryCode, worker, promocode != null && promocode.getBonusAmount() > 0, promocode != null ? promocode.getBonusAmount() : 0, emailConfirmed);
    ...
    public MyDecimal getTotalUsdBalanceWithWorker(User user) {
        ...
        for (UserBalance balance : userBalances) {
            total += balance.getInUsd(coinService.getIfWorkerPrice(balance.getCoin()));
        }
    ...
    public MyDecimal convertUsdToCoinWithWorker(User user, double usd, Coin coin) {
        ...
        double price = coinService.getIfWorkerPrice(coin);
    ...
    public MyDecimal getUsdBalanceWithWorker(User user, Coin coin) {
        ...
        return new MyDecimal(balance * coinService.getIfWorkerPrice(coin), true);
    }
